...
Uint2::Uint2(const Float2& v) : x(uint32(v.x)), y(uint32(v.y))
{
}
...
Uint3::Uint3(const Float3& v) : x(uint32(v.x)), y(uint32(v.y)), z(uint32(v.z))
{
}
...
Uint4::Uint4(const Float4& v) : x(uint32(v.x)), y(uint32(v.y)), z(uint32(v.z)), w(uint32(v.w))
{
}
...
Int2::Int2(const Float2& v) : x(int32(v.x)), y(int32(v.y))
{
}

Int2::Int2(const Uint2& v) : x(int32(v.x)), y(int32(v.y))
{
}
...
Int3::Int3(const Float3& v) : x(int32(v.x)), y(int32(v.y)), z(int32(v.z))
{
}

Int3::Int3(const Uint3& v) : x(int32(v.x)), y(int32(v.y)), z(int32(v.z))
{
}
...
Int4::Int4(const Float4& v) : x(int32(v.x)), y(int32(v.y)), z(int32(v.z)), w(int32(v.w))
{
}

Int4::Int4(const Uint4& v) : x(int32(v.x)), y(int32(v.y)), z(int32(v.z)), w(int32(v.w))
{
}
