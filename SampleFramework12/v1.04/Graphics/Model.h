...
public:
    ...
    void GenerateBoxTestScene(const Float3& bottomBoxDimensions = Float3(10.0f, 0.25f, 10.0f),
                              const Float3& bottomBoxPosition = Float3(0.0f),
                              const Float3& topBoxDimensions = Float3(2.0f),
                              const Float3& topBoxPosition = Float3(0.0f, 1.5f, 0.0f));
