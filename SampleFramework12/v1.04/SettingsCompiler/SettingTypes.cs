...
namespace SettingsCompiler
{
    ...
    public abstract class Setting
    {
        ...
        public bool ShaderCompileTimeConstant = false;
        ...
        public Setting(FieldInfo field, SettingType type, string group)
        {
            ...
            ShaderCompileTimeConstant = ShaderCompileTimeConstantAttribute.IsCompileTime(field);
        ...
        public void WriteHLSLDefinition(List<string> lines)
        {
        ...
        public void WriteCBufferStructDefinition(List<string> lines, ref uint cbSize)
        {
            Debug.Assert(UseAsShaderConstant);
        ...
        public void WriteCBufferUpdate(List<string> lines)
        {
            ...
            lines.Add(string.Format("        cbData." + Name + " = {0};", Name));
        }
    ...
    public class DirectionSetting : Setting
    {
        ...
        public bool DisplayInViewSpace = false;

        public DirectionSetting(Direction value, FieldInfo field, string group)
            : base(field, SettingType.Direction, group)
        {
            Value = value;
            DisplayInViewSpace = DisplayInViewSpaceAttribute.DisplayInViewSpace(field);
        }
        ...
        public override void WriteInitialization(List<string> lines)
        {
            ...
            paramString += MakeParameter(HelpText);
            paramString += MakeParameter(Value);
            paramString += MakeParameter(DisplayInViewSpace);
            lines.Add("        " + Name + ".Initialize(" + paramString + ");");
        }
    }
